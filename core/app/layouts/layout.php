...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>.: ConfigLite - Evilnapsis :.</title>
...
<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="./"><b>CONFIGLITE</b></a>
    </div>

    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="./"><i class='glyphicon glyphicon-home'></i> INICIO</a></li>
        <li><a href="./?view=settings"><i class='glyphicon glyphicon-cog'></i> CONFIGURACION</a></li>
